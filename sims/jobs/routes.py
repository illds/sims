...
@jobs.route("/family/<int:family_id>/update", methods=['GET', 'POST'])
@login_required
def update_family(family_id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('jobs.family', family_id=family.id))
    elif request.method == 'GET':
        form.name.data = family.name

    return render_template('jobs/create_family.html', form=form, legend='Update Family', title='Update Family')


@jobs.route("/family/<int:family_id>/delete", methods=['POST'])
@login_required
